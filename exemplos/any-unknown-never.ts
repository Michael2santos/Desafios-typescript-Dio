...
let stringTeste: string = 'verificando';
...
let frase1: string = 'teste feito com sucesso';
...
//throw
function testeError(erro: string, codigo: Number): never{//pode ser atribuido void ou never
